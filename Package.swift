...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Infomaniak/ios-dependency-injection", .upToNextMajor(from: "2.0.1")),
        ...
        .package(url: "https://github.com/realm/realm-swift", .upToNextMajor(from: "10.45.3")),
        .package(url: "https://github.com/CocoaLumberjack/CocoaLumberjack", .upToNextMajor(from: "3.8.2")),
